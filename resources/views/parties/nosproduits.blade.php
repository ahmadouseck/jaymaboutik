...
<html lang="en">
  ...
  <head>
    ...
    <title>Jayma Boutik - Produits</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Nouvelles Arrivages</h4>
              <h2>JAYMA  produits</h2>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            <div class="filters">
              <ul>
                  ...
                  <li data-filter=".des">Nouveaux</li>
                  <li data-filter=".dev">Flash Offres</li>
                  <li data-filter=".gra">Produits Vedettes</li>
              </ul>
            </div>
          </div>
          <div class="col-md-12">
