...
<html lang="en">
  ...
  <head>
    ...
    <title>Jayma Boutik - Contact</title>
...
-->
          ...
          <div class="col-md-4">
            <div class="left-content">
              <h4>Apropos de notre entreprise</h4>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="contact-form">
              <form id="contact" action="{{url('savemessage')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="name" type="text" class="form-control" id="name" placeholder="Prénom et Nom" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="phone" type="number" class="form-control" id="phone" placeholder="Téléphone" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
          ...
          <div class="col-md-4 ">
               <img src="assets/images/logojayma.png" alt="">
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
                <p>Copyright &copy; 2021 Amadou SECK
              </div>
          </div>
        </div>
      </div>
